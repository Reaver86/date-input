...
describe('DateInputComponent', () => {
  ...
  it('should delete all characters for day when delete or backspace or clear key is pressed', () => {
  ...
  it('should delete all characters for month when delete or backspace or clear key is pressed', () => {
    setInputValueAndBlur(getInput('month'), '2');
    setKeydownValue(getInput('month'), 'Backspace');
    expect(getInput('month').value).toEqual('');
  });

  it('should delete all characters for year when delete key is pressed', () => {
  ...
  @Component({
    template: `
      <app-date-input [formControl]="date" [placeholder]="placeholder"></app-date-input>
    `
  })
